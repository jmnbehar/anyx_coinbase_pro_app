...
import com.anyexchange.anyx.classes.intPercentFormat
import com.anyexchange.anyx.classes.percentFormat
 ...
 */
class FloatSpinnerAdapter(context: Context, var optionList: List<Float>) :
        ArrayAdapter<Float>(context, layoutId, R.id.txt_cb_account_name, optionList) {
    ...
    private fun getViewGeneric(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.optionText?.text = optionList[position].toDouble().intPercentFormat()
