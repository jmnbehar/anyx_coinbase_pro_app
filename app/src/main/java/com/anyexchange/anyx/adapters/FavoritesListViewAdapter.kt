...
import kotlinx.android.synthetic.main.list_row_favorite.view.*
...
class FavoritesListViewAdapter(var inflater: LayoutInflater?, var productList: List<Product>, var onClick: (Product) -> Unit, var onLongPress: (View, Product) -> Unit) : BaseAdapter() {
    var size = 5
    ...
    override fun getView(i: Int, convertView: View?, viewGroup: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            val vi = viewGroup.inflate(R.layout.list_row_favorite)
