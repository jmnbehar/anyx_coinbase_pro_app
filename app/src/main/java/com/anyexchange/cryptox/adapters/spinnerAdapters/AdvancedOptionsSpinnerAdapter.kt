 ...
 */
class AdvancedOptionsSpinnerAdapter(context: Context, var optionList: List<String>) :
        ArrayAdapter<String>(context, layoutId, R.id.txt_cb_account_name, optionList) {
