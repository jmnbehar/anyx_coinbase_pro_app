...
import com.anyexchange.cryptox.views.searchableSpinner.tools.EditCursorColor;
import com.anyexchange.cryptox.views.searchableSpinner.tools.UITools;
...
//        mSearchEditText.setTextColor(mEditViewTextColor);
    ...
    private void revealEditView() {
        ...
        final int openAnimationTime = 150;
        ...
        animator.setDuration(openAnimationTime);
        revealAnimator.setDuration(openAnimationTime);
        ...
        mPopupWindow.getContentView().getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                spinnerListContainerAnimator.setDuration(openAnimationTime);
    ...
    private void hideEditView() {
        ...
        final int closeAnimationTime = 100;
        ...
        mRevealContainerCardView.setVisibility(View.VISIBLE);
        cardViewanimator.setDuration(closeAnimationTime);
        cardViewanimator.start();

        revealAnimator.setDuration(closeAnimationTime);
        revealAnimator.start();
